...
export const SideBar: React.FC<SideBarProps> = ({
  ...
  return (
    <div
      className={`shrink-0 h-auto z-20 fixed top-29 max-h-full py-6 overflow-hidden bg-white text-gray-700 shadow-lg  custom-scroll transition-all duration-300
        ${isCollapsed ? "w-[7rem] " : "w-[26rem] overflow-y-auto"}`}
    >
      <SidebarProvider>
